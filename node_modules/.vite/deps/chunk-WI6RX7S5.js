...
import {
  toMarkdown
} from "./chunk-2RGGVGVQ.js";

// node_modules/.pnpm/@milkdown+exception@7.3.6/node_modules/@milkdown/exception/lib/index.es.js
...
function g(...e2) {
  const o2 = e2.reduce((a2, c4) => {
    if (!c4)
      return a2;
    const s2 = (r2) => Array.isArray(r2) ? r2.map((m3) => s2(m3)).join(", ") : r2.toJSON ? i(r2.toJSON()) : r2.spec ? i(r2.spec) : r2.toString();
    return `${a2}, ${s2(c4)}`;
...
// node_modules/.pnpm/@milkdown+ctx@7.3.6/node_modules/@milkdown/ctx/lib/index.es.js
var P = (o2, s2, i2) => {
  if (!s2.has(o2))
...
var n2 = (o2, s2, i2, r2) => (P(o2, s2, "write to private field"), r2 ? r2.call(o2, i2) : s2.set(o2, i2), i2);
var G = class {
  constructor() {
    this.sliceMap = /* @__PURE__ */ new Map(), this.get = (s2) => {
      const i2 = typeof s2 == "string" ? [...this.sliceMap.values()].find((r2) => r2.type.name === s2) : this.sliceMap.get(s2.id);
      if (!i2) {
        const r2 = typeof s2 == "string" ? s2 : s2.name;
        throw d(r2);
      }
      return i2;
    }, this.remove = (s2) => {
...
var V = class {
  ...
  constructor(s2, i2, r2) {
    ...
    }, this.type = r2, n2(this, m, i2), s2.set(r2.id, this);
  }
...
var _ = class {
  ...
  constructor(s2, i2, r2) {
    ...
    n2(this, w2, /* @__PURE__ */ new Set()), n2(this, S2, /* @__PURE__ */ new Set()), n2(this, f2, /* @__PURE__ */ new Map()), n2(this, M2, /* @__PURE__ */ new Map()), this.read = () => ({
      ...
      e(this, S2).add(t2);
    }, n2(this, T, (t2) => e(this, x2).get(t2).get()), n2(this, j, (t2) => e(this, R).get(t2).status), n2(this, x2, s2), n2(this, R, i2), n2(this, D, r2);
  }
};
...
var L = class L2 {
  ...
  constructor(s2, i2, r2) {
    ...
    a(this, b, void 0);
    a(this, c, void 0);
    this.produce = (t2) => t2 && Object.keys(t2).length ? new L2(e(this, d2), e(this, l2), { ...t2 }) : this, this.inject = (t2, h2) => {
      var O3;
      const v2 = t2.create(e(this, d2).sliceMap);
      return h2 != null && v2.set(h2), (O3 = e(this, c)) == null || O3.onInject(t2), this;
    }, this.remove = (t2) => {
      var h2;
      ...
      return (v2 = e(this, c)) == null || v2.onWait(t2, h2), h2;
    }, this.waitTimers = async (t2) => {
      await Promise.all(this.get(t2).map((h2) => this.wait(h2)));
    }, n2(this, d2, s2), n2(this, l2, i2), n2(this, b, r2), r2 && n2(this, c, new _(s2, i2, r2));
  }
...
var q = class {
  ...
  constructor(s2, i2) {
    ...
    a(this, I, void 0);
    a(this, k, void 0);
    n2(this, C, null), n2(this, g2, null), n2(this, p2, "pending"), this.start = () => (e(this, C) ?? n2(this, C, new Promise((r2, t2) => {
      n2(this, g2, (h2) => {
        h2 instanceof CustomEvent && h2.detail.id === e(this, E) && (n2(this, p2, "resolved"), e(this, I).call(this), h2.stopImmediatePropagation(), r2());
      }), e(this, k).call(this, () => {
      ...
      const r2 = new CustomEvent(this.type.name, { detail: { id: e(this, E) } });
      dispatchEvent(r2);
    }, n2(this, I, () => {
...
var A = class {
  ...
  constructor(s2, i2 = 3e3) {
    this.create = (r2) => new q(r2, this), this.id = Symbol(`Timer-${s2}`), this.name = s2, this.timeout = i2;
  }
};
...
// node_modules/.pnpm/prosemirror-model@1.20.0/node_modules/prosemirror-model/dist/index.js
function findDiffStart(a2, b3, pos) {
  for (let i2 = 0; ; i2++) {
    if (i2 == a2.childCount || i2 == b3.childCount)
      return a2.childCount == b3.childCount ? null : pos;
    let childA = a2.child(i2), childB = b3.child(i2);
    if (childA == childB) {
      pos += childA.nodeSize;
      continue;
    }
...
var Fragment = class _Fragment {
  ...
  */
  nodesBetween(from, to, f3, nodeStart = 0, parent) {
    for (let i2 = 0, pos = 0; pos < to; i2++) {
      ...
      if (end > from && f3(child, nodeStart + pos, parent || null, i2) !== false && child.content.size) {
        let start = pos + 1;
  ...
  */
  forEach(f3) {
    for (let i2 = 0, p4 = 0; i2 < this.content.length; i2++) {
...
function compareDeep(a2, b3) {
  ...
  if (array) {
    ...
    for (let i2 = 0; i2 < a2.length; i2++)
      if (!compareDeep(a2[i2], b3[i2]))
        return false;
  } else {
    for (let p4 in a2)
      if (!(p4 in b3) || !compareDeep(a2[p4], b3[p4]))
        return false;
    for (let p4 in b3)
      if (!(p4 in a2))
        return false;
...
// node_modules/.pnpm/@milkdown+transformer@7.3.6_@milkdown+prose@7.3.6/node_modules/@milkdown/transformer/lib/index.es.js
var G2 = (p4, h2, n3) => {
  if (!h2.has(p4))
    throw TypeError("Cannot " + n3);
};
var r = (p4, h2, n3) => (G2(p4, h2, "read from private field"), n3 ? n3.call(p4) : h2.get(p4));
var c2 = (p4, h2, n3) => {
  if (h2.has(p4))
    throw TypeError("Cannot add the same private member more than once");
  h2 instanceof WeakSet ? h2.add(p4) : h2.set(p4, n3);
};
var o = (p4, h2, n3, t2) => (G2(p4, h2, "write to private field"), t2 ? t2.call(p4, n3) : h2.set(p4, n3), n3);
var Q = class {
};
var U2 = class {
  constructor() {
    this.elements = [], this.size = () => this.elements.length, this.top = () => this.elements.at(-1), this.push = (h2) => {
      var n3;
      (n3 = this.top()) == null || n3.push(h2);
    }, this.open = (h2) => {
      this.elements.push(h2);
    }, this.close = () => {
      const h2 = this.elements.pop();
      if (!h2)
        throw h();
      return h2;
    };
...
var B = class _B extends Q {
  constructor(h2, n3, t2) {
    super(), this.type = h2, this.content = n3, this.attrs = t2;
  }
  push(h2, ...n3) {
    this.content.push(h2, ...n3);
  }
  pop() {
    return this.content.pop();
  }
  static create(h2, n3, t2) {
    return new _B(h2, n3, t2);
  }
};
var d3;
var N;
...
var S3 = class S4 extends U2 {
  ...
  constructor(n3) {
    ...
    c2(this, k2, void 0);
    c2(this, M3, void 0);
    o(this, d3, Mark.none), o(this, N, (t2) => t2.isText), o(this, O, (t2, s2) => {
      if (r(this, N).call(this, t2) && r(this, N).call(this, s2) && Mark.sameSet(t2.marks, s2.marks))
      ...
      const s2 = r(this, T2).call(this, t2);
      s2.spec.parseMarkdown.runner(this, t2, s2);
    }), this.injectRoot = (t2, s2, e2) => (this.openNode(s2, e2), this.next(t2.children), this), this.openNode = (t2, s2) => (this.open(B.create(t2, [], s2)), this), o(this, k2, () => {
      o(this, d3, Mark.none);
      const t2 = this.close();
      return r(this, M3).call(this, t2.type, t2.attrs, t2.content);
    }), this.closeNode = () => (r(this, k2).call(this), this), o(this, M3, (t2, s2, e2) => {
      const i2 = t2.createAndFill(s2, e2, r(this, d3));
      if (!i2)
        throw g(t2, s2, e2);
      return this.push(i2), i2;
    }), this.addNode = (t2, s2, e2) => (r(this, M3).call(this, t2, s2, e2), this), this.openMark = (t2, s2) => {
      const e2 = t2.create(s2);
      return o(this, d3, e2.addToSet(r(this, d3))), this;
    }, this.closeMark = (t2) => (o(this, d3, t2.removeFromSet(r(this, d3))), this), this.addText = (t2) => {
      const s2 = this.top();
      if (!s2)
        throw h();
      const e2 = s2.pop(), i2 = this.schema.text(t2, r(this, d3));
      if (!e2)
        return s2.push(i2), this;
      const a2 = r(this, O).call(this, e2, i2);
      return a2 ? (s2.push(a2), this) : (s2.push(e2, i2), this);
    }, this.build = () => {
      let t2;
      do
        t2 = r(this, k2).call(this);
      while (this.size());
      return t2;
    }, this.next = (t2 = []) => ([t2].flat().forEach((s2) => r(this, F2).call(this, s2)), this), this.toDoc = () => this.build(), this.run = (t2, s2) => {
      const e2 = t2.runSync(t2.parse(s2), s2);
      return this.next(e2), this;
    }, this.schema = n3;
  }
};
d3 = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), T2 = /* @__PURE__ */ new WeakMap(), F2 = /* @__PURE__ */ new WeakMap(), k2 = /* @__PURE__ */ new WeakMap(), M3 = /* @__PURE__ */ new WeakMap(), S3.create = (n3, t2) => {
  const s2 = new S3(n3);
  return (e2) => (s2.run(t2, e2), s2.toDoc());
};
var H2 = S3;
var q2 = class q3 extends Q {
  constructor(h2, n3, t2, s2 = {}) {
    super(), this.type = h2, this.children = n3, this.value = t2, this.props = s2, this.push = (e2, ...i2) => {
      this.children || (this.children = []), this.children.push(e2, ...i2);
    }, this.pop = () => {
      var e2;
...
q2.create = (h2, n3, t2, s2 = {}) => new q2(h2, n3, t2, s2);
var J2 = q2;
var Z = (p4) => Object.prototype.hasOwnProperty.call(p4, "size");
var l3;
var v;
var A2;
var E2;
...
var z = class z2 extends U2 {
  ...
  constructor(n3) {
    ...
    c2(this, C2, void 0);
    c2(this, P2, void 0);
    o(this, l3, Mark.none), o(this, v, (t2) => {
      const s2 = Object.values({ ...this.schema.nodes, ...this.schema.marks }).find((e2) => e2.spec.toMarkdown.match(t2));
      if (!s2)
        throw F(t2.type);
      return s2;
    }), o(this, A2, (t2) => r(this, v).call(this, t2).spec.toMarkdown.runner(this, t2)), o(this, E2, (t2, s2) => r(this, v).call(this, t2).spec.toMarkdown.runner(this, t2, s2)), o(this, w3, (t2) => {
      const { marks: s2 } = t2, e2 = (u4) => u4.type.spec.priority ?? 50;
      [...s2].sort((u4, f3) => e2(u4) - e2(f3)).every((u4) => !r(this, E2).call(this, u4, t2)) && r(this, A2).call(this, t2), s2.forEach((u4) => r(this, P2).call(this, u4));
    }), o(this, j2, (t2, s2) => {
      var f3;
      ...
      const e2 = (y4) => {
        ...
        if (y4.type === s2)
          return y4;
        if (((I3 = y4.children) == null ? void 0 : I3.length) !== 1)
          return null;
        const [b3] = y4.children;
        return b3 ? e2(b3) : null;
      }, i2 = e2(t2);
      if (!i2)
        return t2;
      const a2 = i2.children ? [...i2.children] : void 0, u4 = { ...t2, children: a2 };
      return u4.children = a2, i2.children = [u4], i2;
    }), o(this, x3, (t2) => {
      const { children: s2 } = t2;
      return s2 && (t2.children = s2.reduce((e2, i2, a2) => {
        if (a2 === 0)
          return [i2];
        const u4 = e2.at(-1);
        if (u4 && u4.isMark && i2.isMark) {
          i2 = r(this, j2).call(this, i2, u4.type);
          const { children: f3, ...y4 } = i2, { children: b3, ...I3 } = u4;
          if (i2.type === u4.type && f3 && b3 && JSON.stringify(y4) === JSON.stringify(I3)) {
            const V3 = {
              ...I3,
              children: [...b3, ...f3]
            };
            return e2.slice(0, -1).concat(r(this, x3).call(this, V3));
          }
        }
        return e2.concat(i2);
      }, [])), t2;
    ...
    }), this.openNode = (t2, s2, e2) => (this.open(J2.create(t2, void 0, s2, e2)), this), o(this, m2, () => {
      const t2 = this.close();
      return r(this, g3).call(this, t2.type, t2.children, t2.value, t2.props);
    }), this.closeNode = () => (r(this, m2).call(this), this), o(this, g3, (t2, s2, e2, i2) => {
      const a2 = J2.create(t2, s2, e2, i2), u4 = r(this, x3).call(this, r(this, R2).call(this, a2));
      return this.push(u4), u4;
    }), this.addNode = (t2, s2, e2, i2) => (r(this, g3).call(this, t2, s2, e2, i2), this), o(this, C2, (t2, s2, e2, i2) => t2.isInSet(r(this, l3)) ? this : (o(this, l3, t2.addToSet(r(this, l3))), this.openNode(s2, e2, { ...i2, isMark: true }))), o(this, P2, (t2) => {
      t2.isInSet(r(this, l3)) && (o(this, l3, t2.type.removeFromSet(r(this, l3))), r(this, m2).call(this));
    }), this.withMark = (t2, s2, e2, i2) => (r(this, C2).call(this, t2, s2, e2, i2), this), this.closeMark = (t2) => (r(this, P2).call(this, t2), this), this.build = () => {
      let t2 = null;
      do
        t2 = r(this, m2).call(this);
      while (this.size());
      return t2;
    }, this.next = (t2) => Z(t2) ? (t2.forEach((s2) => {
      r(this, w3).call(this, s2);
    }), this) : (r(this, w3).call(this, t2), this), this.toString = (t2) => t2.stringify(this.build()), this.run = (t2) => (this.next(t2), this), this.schema = n3;
  }
};
l3 = /* @__PURE__ */ new WeakMap(), v = /* @__PURE__ */ new WeakMap(), A2 = /* @__PURE__ */ new WeakMap(), E2 = /* @__PURE__ */ new WeakMap(), w3 = /* @__PURE__ */ new WeakMap(), j2 = /* @__PURE__ */ new WeakMap(), x3 = /* @__PURE__ */ new WeakMap(), R2 = /* @__PURE__ */ new WeakMap(), m2 = /* @__PURE__ */ new WeakMap(), g3 = /* @__PURE__ */ new WeakMap(), C2 = /* @__PURE__ */ new WeakMap(), P2 = /* @__PURE__ */ new WeakMap(), z.create = (n3, t2) => {
  const s2 = new z(n3);
  return (e2) => (s2.run(e2), s2.toString(t2));
};
var K2 = z;

// node_modules/.pnpm/prosemirror-transform@1.8.0/node_modules/prosemirror-transform/dist/index.js
var lower16 = 65535;
...
function canSplit(doc4, pos, depth = 1, typesAfter) {
  ...
  for (let d5 = $pos.depth - 1, i2 = depth - 2; d5 > base2; d5--, i2--) {
    let node = $pos.node(d5), index2 = $pos.index(d5);
...
function joinable2(a2, b3) {
  return !!(a2 && b3 && !a2.isLeaf && a2.canAppend(b3));
}
...
function insertPoint(doc4, pos, nodeType) {
  ...
  if ($pos.parentOffset == 0)
    for (let d5 = $pos.depth - 1; d5 >= 0; d5--) {
      let index = $pos.index(d5);
      if ($pos.node(d5).canReplaceWith(index, index, nodeType))
  ...
  if ($pos.parentOffset == $pos.parent.content.size)
    for (let d5 = $pos.depth - 1; d5 >= 0; d5--) {
      let index = $pos.indexAfter(d5);
      if ($pos.node(d5).canReplaceWith(index, index, nodeType))
        return $pos.after(d5 + 1);
      if (index < $pos.node(d5).childCount)
        return null;
    }
  return null;
}
...
var Fitter = class {
  ...
  findFittable() {
    ...
    for (let cur = this.unplaced.content, d5 = 0, openEnd = this.unplaced.openEnd; d5 < startDepth; d5++) {
      ...
      if (cur.childCount > 1)
        openEnd = 0;
      if (node.type.spec.isolating && openEnd <= d5) {
        startDepth = d5;
        break;
      }
      cur = node.content;
  ...
  close($to) {
    ...
    for (let d5 = close2.depth + 1; d5 <= $to.depth; d5++) {
      let node = $to.node(d5), add = node.type.contentMatch.fillBefore(node.content, true, $to.index(d5));
    ...
    for (; ; ) {
      ...
      for (let i2 = 0; i2 < this.config.plugins.length; i2++) {
        ...
        if (plugin.spec.appendTransaction) {
          let n3 = seen ? seen[i2].n : 0, oldState = seen ? seen[i2].state : this;
...
// node_modules/.pnpm/prosemirror-view@1.33.6/node_modules/prosemirror-view/dist/index.js
...
function posAtCoords(view, coords) {
  ...
  if (safari) {
    for (let p4 = elt; node && p4; p4 = parentNode(p4))
      if (p4.draggable)
        node = void 0;
  }
...
function serializeForClipboard(view, slice) {
  ...
  let text = view.someProp("clipboardTextSerializer", (f3) => f3(slice, view)) || slice.content.textBetween(0, slice.content.size, "\n\n");
...
function readHTML(html) {
  ...
  if (wrap2 = firstTag && wrapMap[firstTag[1].toLowerCase()])
    html = wrap2.map((n3) => "<" + n3 + ">").join("") + html + wrap2.map((n3) => "</" + n3 + ">").reverse().join("");
  elt.innerHTML = html;
  if (wrap2)
    for (let i2 = 0; i2 < wrap2.length; i2++)
...
editHandlers.keypress = (view, _event) => {
  ...
  if (!(sel instanceof TextSelection) || !sel.$from.sameParent(sel.$to)) {
    ...
    if (!/[\r\n]/.test(text) && !view.someProp("handleTextInput", (f3) => f3(view, sel.$from.pos, sel.$to.pos, text)))
...
editHandlers.dragover = editHandlers.dragenter = (_3, e2) => e2.preventDefault();
  ...
  static from(members) {
    switch (members.length) {
      ...
      case 1:
        return members[0];
      default:
        return new _DecorationGroup(members.every((m3) => m3 instanceof DecorationSet) ? members : members.reduce((r2, m3) => r2.concat(m3 instanceof DecorationSet ? m3 : m3.members), []));
    }
  }
};
...
function readDOMChange(view, from, to, typeOver, addedNodes) {
  ...
  if (inlineChange) {
    if ($from.pos == $to.pos) {
      ...
      if (view.someProp("handleTextInput", (f3) => f3(view, chFrom, chTo, text)))
        return;
...
var undoInputRule = (state, dispatch) => {
  ...
  for (let i2 = 0; i2 < plugins.length; i2++) {
    let plugin = plugins[i2], undoable;
...
// node_modules/.pnpm/@milkdown+prose@7.3.6/node_modules/@milkdown/prose/lib/index.js
...
function run(view, from, to, text, rules, plugin) {
  ...
  for (let i2 = 0; i2 < rules.length; i2++) {
    ...
    const tr = match && match[0] && rules[i2].handler(state, match, from - (match[0].length - text.length), to);
    if (!tr)
      continue;
...
// node_modules/.pnpm/@milkdown+core@7.3.6_@milkdown+ctx@7.3.6_@milkdown+prose@7.3.6_@milkdown+transformer@7.3.6/node_modules/@milkdown/core/lib/index.es.js
var ve = (e2, t2, r2) => {
  if (!t2.has(e2))
    throw TypeError("Cannot " + r2);
};
var s = (e2, t2, r2) => (ve(e2, t2, "read from private field"), r2 ? r2.call(e2) : t2.get(e2));
var d4 = (e2, t2, r2) => {
  if (t2.has(e2))
    throw TypeError("Cannot add the same private member more than once");
  t2 instanceof WeakSet ? t2.add(e2) : t2.set(e2, r2);
};
var c3 = (e2, t2, r2, i2) => (ve(e2, t2, "write to private field"), i2 ? i2.call(e2, r2) : t2.set(e2, r2), r2);
function k4(e2, t2) {
  return e2.meta = {
...
var De = {
  strong: (e2, t2, r2, i2) => {
    const n3 = e2.marker || r2.options.strong || "*", a2 = r2.enter("strong"), h2 = r2.createTracker(i2);
    let m3 = h2.move(n3 + n3);
    return m3 += h2.move(
      r2.containerPhrasing(e2, {
        before: m3,
        after: n3,
        ...h2.current()
      })
    ), m3 += h2.move(n3 + n3), a2(), m3;
  },
  emphasis: (e2, t2, r2, i2) => {
    const n3 = e2.marker || r2.options.emphasis || "*", a2 = r2.enter("emphasis"), h2 = r2.createTracker(i2);
    let m3 = h2.move(n3);
    return m3 += h2.move(
      r2.containerPhrasing(e2, {
        before: m3,
...
function ot(e2) {
  const t2 = (r2) => (r2.record(L3), async () => (await e2(r2), r2.done(L3), () => {
    r2.clearTimer(L3);
  }));
  return k4(t2, {
    displayName: "Config"
...
function at(e2) {
  const t2 = (r2) => (r2.inject(ke, e2).inject(N3, []).inject(pe, []).inject(ue, []).inject(fe, []).inject(ye, []).inject(Q2, {
    handlers: De
  }).inject(P3, unified().use(remarkParse).use(remarkStringify)).inject(G3, [L3]).record(M4), async () => {
    await r2.waitTimers(G3);
    const i2 = r2.get(Q2);
    return r2.set(P3, unified().use(remarkParse).use(remarkStringify, i2)), r2.done(M4), () => {
      r2.remove(ke).remove(N3).remove(pe).remove(ue).remove(fe).remove(ye).remove(Q2).remove(P3).remove(G3).clearTimer(M4);
    };
  });
  return k4(t2, {
    displayName: "Init"
...
function Te(e2) {
  ...
  return {
    ...e2,
    parseDOM: (t2 = e2.parseDOM) == null ? void 0 : t2.map((r2) => ({ priority: e2.priority, ...r2 }))
  };
}
var Ee = (e2) => (e2.inject(b2, {}).inject(X, []).inject(Z2, []).inject(U3, [M4]).record(R3), async () => {
  await e2.waitTimers(U3);
  const t2 = e2.get(P3), i2 = e2.get(pe).reduce((m3, f3) => m3.use(f3.plugin, f3.options), t2);
  e2.set(P3, i2);
  const n3 = Object.fromEntries(e2.get(X).map(([m3, f3]) => [m3, Te(f3)])), a2 = Object.fromEntries(e2.get(Z2).map(([m3, f3]) => [m3, Te(f3)])), h2 = new Schema({ nodes: n3, marks: a2 });
  return e2.set(b2, h2), e2.done(R3), () => {
    e2.remove(b2).remove(X).remove(Z2).remove(U3).clearTimer(R3);
  };
});
k4(Ee, {
  displayName: "Schema"
...
var Ve = (e2) => (e2.inject(Y, Ie).inject(x4, [R3]).record(W2), async () => {
  await e2.waitTimers(x4);
  const t2 = e2.get(P3), r2 = e2.get(b2);
  return e2.set(Y, H2.create(r2, t2)), e2.done(W2), () => {
    e2.remove(Y).remove(x4).clearTimer(W2);
  };
});
k4(Ve, {
  displayName: "Parser"
...
var Ne = (e2) => (e2.inject(te, Me).inject(ee, [R3]).record($), async () => {
  await e2.waitTimers(ee);
  const t2 = e2.get(P3), r2 = e2.get(b2);
  return e2.set(te, K2.create(r2, t2)), e2.done($), () => {
...
function ct(e2, t2, r2) {
  if (typeof e2 == "string")
    return t2(e2);
  if (e2.type === "html")
    return DOMParser.fromSchema(r2).parse(e2.dom);
  if (e2.type === "json")
    return Node.fromJSON(r2, e2.value);
  throw l(e2);
}
...
var _e = (e2) => (e2.inject(re, "").inject(V2, {}).inject(se, (t2) => t2).inject(ie4, [W2, $, J3]).record(q4), async () => {
  await e2.waitTimers(ie4);
  const t2 = e2.get(b2), r2 = e2.get(Y), i2 = e2.get(ue), n3 = e2.get(se), a2 = e2.get(N3), h2 = e2.get(re), m3 = ct(h2, r2, t2), f3 = [
    ...a2,
    new Plugin({
      key: mt,
      state: {
  ...
  const B2 = n3({
    ...
    doc: m3,
    plugins: f3
  }), l4 = EditorState.create(B2);
  return e2.set(V2, l4), e2.done(q4), () => {
    e2.remove(re).remove(V2).remove(se).remove(ie4).clearTimer(q4);
  };
});
k4(_e, {
...
function ht(e2, t2) {
  ...
  r2.className = "milkdown", e2.appendChild(r2), t2.set(we, r2);
  const i2 = t2.get(ge);
  return Object.entries(i2).forEach(([n3, a2]) => r2.setAttribute(n3, a2)), r2;
}
function lt(e2) {
  e2.classList.add("editor"), e2.setAttribute("role", "textbox");
}
var ut = new PluginKey("MILKDOWN_VIEW_CLEAR");
var ze = (e2) => (e2.inject(ce, document.body).inject(H3, {}).inject(ae, {}).inject(we, null).inject(ge, {}).inject(oe, [q4]).record(ne), async () => {
  await e2.wait(M4);
  const t2 = e2.get(ce) || document.body, r2 = typeof t2 == "string" ? document.querySelector(t2) : t2;
  e2.update(N3, (f3) => [
    new Plugin({
      key: ut,
      view: (B2) => {
        const l4 = r2 ? ht(r2, e2) : void 0;
        return (() => {
          if (l4 && r2) {
            const F3 = B2.dom;
            r2.replaceChild(l4, F3), l4.appendChild(F3);
          }
        })(), {
          destroy: () => {
            l4 != null && l4.parentNode && (l4 == null || l4.parentNode.replaceChild(B2.dom, l4)), l4 == null || l4.remove();
          }
        };
      }
    }),
  ...
  const i2 = e2.get(V2), n3 = e2.get(ae), a2 = Object.fromEntries(e2.get(fe)), h2 = Object.fromEntries(e2.get(ye)), m3 = new EditorView(r2, {
    state: i2,
    nodeViews: a2,
    markViews: h2,
    ...n3
  });
  return lt(m3.dom), e2.set(H3, m3), e2.done(ne), () => {
    m3 == null || m3.destroy(), e2.remove(ce).remove(H3).remove(ae).remove(we).remove(ge).remove(oe).clearTimer(ne);
  };
});
k4(ze, {
...
var Ke = class {
  ...
  call(t2, r2) {
    if (s(this, g4) == null)
      throw y();
    const n3 = this.get(t2)(r2), a2 = s(this, g4).get(H3);
...
var Ae = (e2) => {
  const t2 = new Ke();
  return t2.setCtx(e2), e2.inject(je, t2).inject(me, [R3]).record(J3), async () => (await e2.waitTimers(me), e2.done(J3), () => {
    e2.remove(je).remove(me).clearTimer(J3);
  });
};
k4(Ae, {
...
var Ce = class Ce2 {
  constructor() {
    ...
    c3(this, j3, false), c3(this, p3, "Idle"), c3(this, y3, []), c3(this, D2, () => {
      ...
      const t2 = ot(async (i2) => {
        await Promise.all(s(this, y3).map((n3) => n3(i2)));
      }), r2 = [
        Ee,
        Ve,
        Ne,
      ...
      s(this, S5).call(this, r2, s(this, w4));
    }), c3(this, S5, (t2, r2) => {
      t2.forEach((i2) => {
        const n3 = s(this, O2).produce(s(this, j3) ? i2.meta : void 0), a2 = i2(n3);
        r2.set(i2, { ctx: n3, handler: a2, cleanup: void 0 });
      });
    }), c3(this, E3, (t2, r2 = false) => Promise.all(
      [t2].flat().map((i2) => {
        const n3 = s(this, u3).get(i2), a2 = n3 == null ? void 0 : n3.cleanup;
        return r2 ? s(this, u3).delete(i2) : s(this, u3).set(i2, { ctx: void 0, handler: void 0, cleanup: void 0 }), typeof a2 == "function" ? a2() : a2;
      })
    )), c3(this, A3, async () => {
      await Promise.all([...s(this, w4).entries()].map(([t2, { cleanup: r2 }]) => typeof r2 == "function" ? r2() : r2)), s(this, w4).clear();
    }), c3(this, C3, (t2) => {
      c3(this, p3, t2), s(this, D2).call(this, t2);
    }), c3(this, I2, (t2) => [...t2.entries()].map(async ([r2, i2]) => {
      const { ctx: n3, handler: a2 } = i2;
      if (!a2)
        return;
      const h2 = await a2();
      t2.set(r2, { ctx: n3, handler: a2, cleanup: h2 });
    })), this.enableInspector = (t2 = true) => (c3(this, j3, t2), this), this.onStatusChange = (t2) => (c3(this, D2, t2), this), this.config = (t2) => (s(this, y3).push(t2), this), this.removeConfig = (t2) => (c3(this, y3, s(this, y3).filter((r2) => r2 !== t2)), this), this.use = (t2) => {
      const r2 = [t2].flat();
      return r2.flat().forEach((i2) => {
        s(this, u3).set(i2, {
          ctx: void 0,
          handler: void 0,
          cleanup: void 0
        });
      }), s(this, p3) === "Created" && s(this, S5).call(this, r2, s(this, u3)), this;
    }, this.remove = async (t2) => s(this, p3) === "OnCreate" ? (console.warn("[Milkdown]: You are trying to remove plugins when the editor is creating, this is not recommended, please check your code."), new Promise((r2) => {
      setTimeout(() => {
        r2(this.remove(t2));
      }, 50);
    })) : (await s(this, E3).call(this, [t2].flat(), true), this), this.create = async () => s(this, p3) === "OnCreate" ? this : (s(this, p3) === "Created" && await this.destroy(), s(this, C3).call(this, "OnCreate"), s(this, K3).call(this), s(this, S5).call(this, [...s(this, u3).keys()], s(this, u3)), await Promise.all(
      [
        s(this, I2).call(this, s(this, w4)),
        s(this, I2).call(this, s(this, u3))
      ].flat()
    ), s(this, C3).call(this, "Created"), this), this.destroy = async (t2 = false) => s(this, p3) === "Destroyed" || s(this, p3) === "OnDestroy" ? this : s(this, p3) === "OnCreate" ? new Promise((r2) => {
      setTimeout(() => {
        r2(this.destroy(t2));
      }, 50);
    }) : (t2 && c3(this, y3, []), s(this, C3).call(this, "OnDestroy"), await s(this, E3).call(this, [...s(this, u3).keys()], t2), await s(this, A3).call(this), s(this, C3).call(this, "Destroyed"), this), this.action = (t2) => t2(s(this, O2)), this.inspect = () => s(this, j3) ? [...s(this, w4).values(), ...s(this, u3).values()].map(({ ctx: t2 }) => {
      var r2;
      return (r2 = t2 == null ? void 0 : t2.inspector) == null ? void 0 : r2.read();
...
j3 = /* @__PURE__ */ new WeakMap(), p3 = /* @__PURE__ */ new WeakMap(), y3 = /* @__PURE__ */ new WeakMap(), D2 = /* @__PURE__ */ new WeakMap(), _2 = /* @__PURE__ */ new WeakMap(), z3 = /* @__PURE__ */ new WeakMap(), u3 = /* @__PURE__ */ new WeakMap(), w4 = /* @__PURE__ */ new WeakMap(), O2 = /* @__PURE__ */ new WeakMap(), K3 = /* @__PURE__ */ new WeakMap(), S5 = /* @__PURE__ */ new WeakMap(), E3 = /* @__PURE__ */ new WeakMap(), A3 = /* @__PURE__ */ new WeakMap(), C3 = /* @__PURE__ */ new WeakMap(), I2 = /* @__PURE__ */ new WeakMap();
var Oe = Ce;
...
//# sourceMappingURL=chunk-WI6RX7S5.js.map
