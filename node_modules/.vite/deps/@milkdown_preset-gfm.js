import {
  remarkGfm
} from "./chunk-2QGFZA6R.js";
import {
  M,
  w
} from "./chunk-6GGUDNCL.js";
...
// node_modules/.pnpm/prosemirror-tables@1.3.7/node_modules/prosemirror-tables/dist/index.js
var readFromCache;
var addToCache;
...
// node_modules/.pnpm/@milkdown+preset-gfm@7.3.6_@milkdown+core@7.3.6_@milkdown+ctx@7.3.6_@milkdown+preset-commonma_2iriv6lenk36qqmg55vbs3ewfi/node_modules/@milkdown/preset-gfm/lib/index.es.js
function d(e, t) {
...
var H = re("ToggleStrikeThrough", (e) => () => toggleMark(T.type(e)));
d(H, {
  displayName: "Command<ToggleStrikethrough>",
  group: "Strikethrough"
});
var ae = oe((e) => markRule(/~([^~]+)~$/, T.type(e)));
d(ae, {
  displayName: "InputRule<strikethrough>",
  group: "Strikethrough"
});
var L = ge("strikeThroughKeymap", {
  ToggleStrikethrough: {
    shortcuts: "Mod-Alt-x",
    command: (e) => {
      const t = e.get(je);
...
function se(e, t = 3, n = 3) {
  const o = Array(n).fill(0).map(() => M2.type(e).createAndFill()), l = Array(n).fill(0).map(() => I.type(e).createAndFill()), r = Array(t).fill(0).map((s, c) => R.type(e).create(null, c === 0 ? l : o));
  return S2.type(e).create(null, r);
}
function w2(e) {
...
function tt(e, t, n, o) {
  let l = q(me(e.node));
  return l = ue2(l, t, n, o), l = q(l), de(e.node, l);
}
function ot(e, t, n, o) {
  let l = me(e.node);
  return l = ue2(l, t, n, o), de(e.node, l);
}
function J(e, t) {
  let n = e, o = e;
  for (let a = e; a >= 0; a--) {
...
var pe = oe((e) => new InputRule(
  /^\|(?<col>\d+)[xX](?<row>\d+)\|\s$/,
  (t, n, o, l) => {
    var i, m;
    const r = t.doc.resolve(o);
    if (!r.node(-1).canReplaceWith(r.index(-1), r.indexAfter(-1), S2.type(e)))
      return null;
    const s = se(
      e,
...
var W = re("GoToPrevTableCell", () => () => goToNextCell(-1));
d(W, {
  displayName: "Command<goToPrevTableCellCommand>",
  group: "Table"
});
var G = re("GoToNextTableCell", () => () => goToNextCell(1));
d(G, {
  displayName: "Command<goToNextTableCellCommand>",
  group: "Table"
});
var z = re("BreakTable", (e) => () => (t, n) => {
  if (!isInTable(t))
    return false;
  const { $head: o } = t.selection, l = o.after(), r = t.tr.replaceWith(l, l, w.type(e).createAndFill());
...
var fe2 = re("InsertTable", (e) => ({ row: t, col: n } = {}) => (o, l) => {
  const { selection: r, tr: s } = o, { from: c } = r, i = se(e, t, n), m = s.replaceSelectionWith(i), a = Selection.findFrom(m.doc.resolve(c), 1, true);
...
var he = re("MoveRow", () => ({ from: e, to: t } = {}) => (n, o) => {
  const { tr: l } = n;
  return !!(o == null ? void 0 : o(lt(l, e ?? 0, t ?? 0, true)));
});
d(he, {
...
var ge2 = re("MoveCol", () => ({ from: e, to: t } = {}) => (n, o) => {
  const { tr: l } = n;
  return !!(o == null ? void 0 : o(nt(l, e ?? 0, t ?? 0, true)));
});
d(ge2, {
  displayName: "Command<moveColCommand>",
  group: "Table"
});
var be = re("SelectRow", () => (e = 0) => (t, n) => {
  const { tr: o } = t;
...
var ke2 = re("DeleteSelectedCells", () => () => (e, t) => {
  const { selection: n } = e;
...
var we2 = re("AddColBefore", () => () => addColumnBefore);
d(we2, {
  displayName: "Command<addColBeforeCommand>",
  group: "Table"
});
var Ne = re("AddColAfter", () => () => addColumnAfter);
d(Ne, {
  displayName: "Command<addColAfterCommand>",
  group: "Table"
});
var Te = re("AddRowBefore", (e) => () => (t, n) => {
  if (!isInTable(t))
    return false;
  if (n) {
...
var Re = re("SetAlign", () => (e = "left") => setCellAttr("alignment", e));
d(Re, {
  displayName: "Command<setAlignCommand>",
  group: "Table"
});
var j = ge("tableKeymap", {
  NextCell: {
    shortcuts: ["Mod-]", "Tab"],
    command: (e) => {
      const t = e.get(je);
...
var Y = "footnoteDefinition";
var Z = fe("footnote_definition", () => ({
  group: "block",
  content: "block+",
  defining: true,
  attrs: {
...
var Ae = oe(() => new InputRule(/^\[(?<checked>\s|x)\]\s$/, (e, t, n, o) => {
  var a;
...
var xe = ue((e) => {
  const t = new PluginKey("MILKDOWN_AUTO_INSERT_ZERO_SPACE"), n = (l) => l.type === w.type(e), o = (l) => n(l) && l.nodeSize === 2;
  return new Plugin({
    key: t,
    props: {
      handleDOMEvents: {
...
var ve = ue(() => columnResizing({}));
d(ve, {
  displayName: "Prose<columnResizingPlugin>",
  group: "Prose"
});
var Ie = ue(() => tableEditing());
d(Ie, {
  displayName: "Prose<tableEditingPlugin>",
  group: "Prose"
});
var U = ke("remarkGFM", () => remarkGfm);
d(U.plugin, {
...
var wt = [it, at, st, rt, ct, dt].flat();
export {
  Ne as addColAfterCommand,
  we2 as addColBeforeCommand,
  ...
  dt as commands,
  se as createTable,
  ke2 as deleteSelectedCellsCommand,
