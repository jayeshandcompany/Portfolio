...
exports.default = createRule({
    ...
    create(context) {
        ...
        function checkIdentifierInJSX(node, { isComponent, isCustomDirective, } = {}) {
            let scope = (0, compat_1.getScope)(context, node);
                ...
                if (autoImport && missingComponents.length) {
                    ...
                    if (importNode) {
                        context.report({
                            ...
                            fix: (fixer) => {
                                return (0, utils_2.appendImports)(fixer, (0, compat_1.getSourceCode)(context), importNode, missingComponents);
                            },
                        });
                    }
                    else {
                        context.report({
                            ...
                            fix: (fixer) => {
                                return (0, utils_2.insertImports)(fixer, (0, compat_1.getSourceCode)(context), "solid-js", missingComponents);
                            },
                        });
                    }
                }
