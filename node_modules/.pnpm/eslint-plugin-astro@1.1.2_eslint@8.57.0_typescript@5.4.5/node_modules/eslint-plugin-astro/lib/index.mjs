...
function getStaticAttributeValue(node, context) {
  var _a2, _b2;
  if (((_a2 = node.value) == null ? void 0 : _a2.type) === AST_NODE_TYPES.Literal) {
...
function transform(node, context) {
  ...
  try {
    ...
    const result = postcss(config.plugins).process(code, __spreadProps(__spreadValues({}, config.options), {
      map: {
        inline: false
      }
    }));
...
function transformToStyleContentCSS(transform5, context) {
  ...
  function remapPosition(pos) {
    decoded = decoded != null ? decoded : decode(transform5.mappings);
        ...
        function verifyAttr(attr) {
          ...
          function findClosestObject(array, target) {
            ...
            for (let index2 = 0; index2 < length; index2++) {
              ...
              if ((after == null ? void 0 : after.type) === AST_NODE_TYPES.ObjectExpression) {
                return after;
              }
              const before = beforeElements[index2];
              if ((before == null ? void 0 : before.type) === AST_NODE_TYPES.ObjectExpression) {
                return before;
              }
            }
            return null;
  ...
  "src/configs/flat/base.ts"() {
    ...
    base_default = [
      ...
      },
      {
        files: ["*.astro", "**/*.astro"],
        languageOptions: {
          globals: __spreadValues(__spreadValues({}, globals.node), environments.astro.globals),
          parser: parser2,
...
var all_default = [
  ...recommended_default,
  {
    rules: __spreadValues(__spreadValues({}, all), recommended_default[recommended_default.length - 1].rules)
  }
];
