...
hoistedDependencies:
  ...
  /astro-eslint-parser/1.0.2(typescript@5.4.5):
    astro-eslint-parser: public
  /astrojs-compiler-sync/1.0.0(@astrojs/compiler@2.7.1):
  ...
  /eslint-plugin-astro/1.1.2(eslint@8.57.0)(typescript@5.4.5):
    eslint-plugin-astro: public
  /eslint-plugin-format/0.1.1(eslint@8.57.0):
...
pendingBuilds: []
prunedAt: Tue, 11 Jun 2024 15:14:18 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /@rollup/rollup-win32-x64-msvc/4.17.2
  - /fsevents/2.3.3
storeDir: /home/runner/Portfolio/.local/share/pnpm/store/v3
